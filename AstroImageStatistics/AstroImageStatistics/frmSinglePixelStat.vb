...
Public Class frmSinglePixelStat
    ...
    Private Sub Run()
        ...
        Dim OffsetX As Integer = CInt(tbOffsetX.Text)               'X offset start position
        Dim OffsetY As Integer = CInt(tbOffsetY.Text)               'Y offset start position
        ...
        For Each File As String In AllDataOffsets.Keys
            ...
            StringValues.Add(FileNameOnly.PadRight(100) & ":" & PixelValueFast.ValRegIndep.PadLeft(5))
